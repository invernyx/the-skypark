    ...
    public class WpfEmbeddedBrowser : IBrowser
    {
        ...
        public async Task<BrowserResult> InvokeAsync(BrowserOptions options, CancellationToken cancellationToken = default)
        {
            ...
            var window = new Window()
            {
                Width = 414,
                Height = 727,
                Title = "The Skypark Authentication"
            };
            ...
            var signal = new SemaphoreSlim(0, 10);
        ...
        {
            return uri.AbsoluteUri.StartsWith(_options.EndUrl) && !uri.AbsolutePath.ToLower().EndsWith("endsession") && !uri.AbsolutePath.ToLower().Contains("logout");
        }
    }
    */
}