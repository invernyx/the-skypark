...
namespace TSP_Transponder.Models.Transactor
{
    public class Fee
    {
        ...
        public Fee(Dictionary<string, dynamic> Restore)
        {
            ...
            RefundMoment = Restore.ContainsKey("RefundMoment") ? (MOMENT)EnumAttr.GetEnum(typeof(MOMENT), (string)Restore["RefundMoment"]) : MOMENT.NONE;
        ...
        public Dictionary<string, dynamic> ToDictionary()
        {
            ...
            {
                rs.Add("RefundMoment", EnumAttr.GetDescription(RefundMoment));
            }
        ...
        public Dictionary<string, dynamic> ToListing()
        {
            ...
            if (RefundMoment != MOMENT.NONE)
            {
                rs.Add("refund_moment", EnumAttr.GetDescription(RefundMoment));
            }
            ...
            if (InclIf != null)
            {
                rs.Add("incl_if", InclIf);
            }

            if (ExclIf != null)
            {
                rs.Add("excl_if", ExclIf);
            }
            ...
            if (Discounts != null)
            {
                rs.Add("discounts", Discounts.Select(x => x.ToListing()).ToList());
            }
