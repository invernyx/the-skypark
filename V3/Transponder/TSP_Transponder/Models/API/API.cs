    ...
    { 
        ...
        */
        ...
        public static void FindHost()
        {
            ...
            CDNHost = "https://storage.googleapis.com/gilfoyle/the-skypark/v1/";
            CDNChannel = "prod";
            CDNImagesHost = CDNHost + "common/images";

            if (UserData.Get("channel") == "staging")
            {
                APIEndpoint = "http://api-staging." + APIHost + "/";
                WSEndpoint = "wss://socket-staging." + APIHost + ":443";
                SkyOSHost = "https://skypad-staging." + APIHost;
                CDNHost = "https://storage.googleapis.com/gilfoyle/the-skypark/v1/";
                CDNChannel = "staging";
                CDNImagesHost = CDNHost + "common/images";
            }
            ...
            {
                APIEndpoint = "http://api-dev." + APIHost + "/";
                WSEndpoint = "ws://api-dev.theskypark.com/ws";
                SkyOSHost = "https://skypad-dev." + APIHost;
                CDNHost = "https://storage.googleapis.com/gilfoyle/the-skypark/v1/";
                CDNChannel = "dev";
                CDNImagesHost = CDNHost + "common/images";
            }
