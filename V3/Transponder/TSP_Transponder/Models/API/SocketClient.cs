        ...
        public void CommonReceive(Dictionary<string, dynamic> structure)
        {
            ...
            switch (StructSplit[0])
            {
                ...
                case "cabin":
                    {
                        #region cabin
                        AircraftCabin.Command(this, StructSplit, structure);
                        break;
                        #endregion
                    }
                ...
                case "messaging":
                    {
                        ...
                        switch (StructSplit[1])
                        {
                            case "chat":
                                {
                                    Messaging.Chat.Command(this, StructSplit, structure);
                                    break;
                                }
                            case "message":
                                {
                                    Messaging.Message.Command(this, StructSplit, structure);
                                    break;
                                }
                        }
                        break;
                ...
                case "scenr":
                    {
                        ...
                        switch (StructSplit[1])
                        {
                            case "cargotags":
                                {
                                    CargoAssetsLibrary.Command(this, StructSplit, structure);
                                    break;
                                }
