...
{
    class CargoAssetsLibrary
    {
        internal static List<CargoAsset> CargoItems = new List<CargoAsset>();
        internal static Dictionary<string, List<CargoAsset>> CargoItemsByTag = new Dictionary<string, List<CargoAsset>>();
        ...
        internal static void Init()
        {
            ...
            while(i < AssetsCSV.Count){
                ...
                try
                {
                    ...
                    CargoAsset NewCargo = new CargoAsset();
                    ...
                    foreach (string Tag in NewCargo.Tags)
                    {
                        ...
                        {
                            CargoItemsByTag.Add(Tag, new List<CargoAsset>());
                        }
        ...
        internal static CargoAsset GetFromGUID(string GUID)
        {
