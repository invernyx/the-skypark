...
namespace TSP_Transponder.Models
{
    public class GoogleAnalyticscs
    {
        ...
        {
            #region Get GA
            GATrack = new SimpleTracker("UA-131324058-1", new AnalyticsSession(UserData.Get("ga")), new SimpleTrackerEnvironment(Environment.OSVersion.Platform.ToString(), Environment.OSVersion.Version.ToString(), Environment.OSVersion.VersionString));
