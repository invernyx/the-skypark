...
namespace TSP_Transponder.Models.Adventures.Actions
{
    ...
    class trigger_ias_start : action_base
    {
        ...
        public trigger_ias_start(Adventure Adv, AdventureTemplate Template, Situation Sit, int ID, Dictionary<string, dynamic> Params, action_base Parent) : base(Adv, Template, Sit, ID, Params, Parent)
        {
            ActionName = "trigger_ias_start";
            ...
            if (Adv != null)
            {
                if (Link == null)
                {
                    ...
                    {
                        if (action.Value.GetType() == typeof(trigger_ias_end))
                        {
                            trigger_ias_end TestAction = (trigger_ias_end)action.Value;
        ...
        public override void Process()
        {
            ...
            if (Math.Abs(AdventuresBase.TemporalNewBuffer.AIRSPEED_TRUE) > Max)
            {
                newExceeds = true;
            }

            if (Math.Abs(AdventuresBase.TemporalNewBuffer.AIRSPEED_TRUE) < Min)
            {
                newExceeds = true;
            }
            Exceeds = newExceeds;
