    ...
    class AviationWeather_gov
    {
        ...
        public static WeatherData GetWeatherStation(string Station, GeoLoc Location)
        {
            ...
            Action<string[]> Decode = (WeatherSplit) =>
            {
                ...
                wd.DewPoint = WeatherSplit[6] == "" ? (short)0 : Convert.ToInt16(Math.Round(Convert.ToSingle(WeatherSplit[6])));
                wd.WindHeading = WeatherSplit[7] == "" ? (short)0 : Convert.ToInt16(Math.Round(Convert.ToSingle(WeatherSplit[7])));
                wd.WindSpeed = WeatherSplit[8] == "" ? (short)0 : Convert.ToInt16(Math.Round(Convert.ToSingle(WeatherSplit[8])));
                wd.WindGust = WeatherSplit[9] == "" ? (short)0 : Convert.ToInt16(Math.Round(Convert.ToSingle(WeatherSplit[9])));
                wd.Temperature = WeatherSplit[5] == "" ? (short)0 : Convert.ToInt16(Math.Round(Convert.ToSingle(WeatherSplit[5])));
                wd.VisibilitySM = WeatherSplit[10] == "" ? (int)-1 : Convert.ToInt32(Math.Round(Convert.ToSingle(WeatherSplit[10]) * 1609.344));
                                ...
                                default:
                                    {
                                        wd.Clouds.Add(new CloudLayer()
                                        {
                                            ...
                                            Coverage = (Cloud_Coverage)EnumAttr.GetEnum(typeof(Cloud_Coverage), WeatherSplit[22]),
                                        });
                    ...
                    if (WeatherSplit[24] != string.Empty)
                    {
                        try
                        {
                            wd.Clouds.Add(new CloudLayer()
                            {
                                ...
                                Coverage = (Cloud_Coverage)EnumAttr.GetEnum(typeof(Cloud_Coverage), WeatherSplit[24]),
                            });
                        }
                        catch
                        {
                    ...
                    if (WeatherSplit[26] != string.Empty)
                    {
                        try
                        {
                            wd.Clouds.Add(new CloudLayer()
                            {
                                ...
                                Coverage = (Cloud_Coverage)EnumAttr.GetEnum(typeof(Cloud_Coverage), WeatherSplit[26]),
                            });
                        }
                        catch
                        {
                    ...
                    if (WeatherSplit[28] != string.Empty)
                    {
                        try
                        {
                            wd.Clouds.Add(new CloudLayer()
                            {
                                ...
                                Coverage = (Cloud_Coverage)EnumAttr.GetEnum(typeof(Cloud_Coverage), WeatherSplit[28]),
                            });
                        }
                        catch
                        {
            ...
            else
            {
                ...
                {
                    List<KeyValuePair<double, Airport>> Apts = SimLibrary.SimList[0].AirportsLib.GetAirportByRange(Location, 92.6f);
                ...
                case "get":
                    {
                        ...
                        Socket.SendMessage("response", wd != null ? App.JSSerializer.Serialize(wd.Serialize(null)) : "null", (Dictionary<string, dynamic>)structure["meta"]);
                        break;
                    }
            }
        }
