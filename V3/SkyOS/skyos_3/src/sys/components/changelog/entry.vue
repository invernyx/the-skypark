<template>
	<div class="app-box shadowed-deep">
		<div class="changelog-entry">
			<div v-if="color_bright && entry.image" class="changelog-entry-background" :style="'background-color:' + (theme == 'theme--bright' ? color_bright : color_dark) + ';background-image:url(' + entry.image + ')'"></div>
...
export default Vue.extend({
	...
	mounted() {
		if(this.entry.image) {
			...
			this.$os.colorSeek.find(this.entry.image, 160, (color :any) => {
