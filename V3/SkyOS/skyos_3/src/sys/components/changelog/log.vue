<template>
	<div class="changelog" v-if="log">
		...
		<div class="changelog-entries">
			...
			<div class="app-box transparent nooutline">
				<button_action class="info shadowed-deep" @click.native="realLimit += 4" v-if="log.entries.length - realLimit > 0">Load more... ({{ log.entries.length - realLimit }} left)</button_action>
			</div>
		</div>
	</div>
</template>
