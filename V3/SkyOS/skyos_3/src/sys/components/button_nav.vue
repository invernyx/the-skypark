<template>
	<div class="button_nav" :class="[theme, { 'heldnotice': holdNotice, 'hold': hold, 'held': hold && heldTimeout, 'grow': grow, 'button_nav-back': shape == 'back', 'button_nav-forward': shape == 'forward', 'is-icon': !Object.keys($slots).length }]" @mouseleave="holdEvEnd" @mousedown="holdEvStart" @mouseup="holdEvEnd" @click="clickEv">
...
.button_nav {
	...
	* {
	...
	&:before {
		...
		transition: right 0.5s 0.1s ease-in;
	}
