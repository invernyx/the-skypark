			...
			<template v-slot:content>
				<div class="filter_section h_edge_padding">
					...
					<div class="filter_entry">
						<div class="columns columns_2 columns_margined">
							<div class="column column_2 column_h-stretch">
								<toggle v-model="filters.requiresLight" @modified="changed">Require runway lighting</toggle>
							</div>
						</div>
					</div>
					...
					<div class="filter_entry">
						<div class="columns columns_2 columns_margined">
							<div class="column column_2 column_h-stretch">
								<toggle v-model="filters.requiresILS" @modified="changed">Require ILS on arrival</toggle>
							</div>
						</div>
					</div>
