<template>
	<div class="progress" v-if="progress && this.unlock" :data-thook="'progress_section_reliability'">
	...
	<div class="progress" v-else :data-thook="'progress_section_reliability'">
		<div class="progress-box">
			<div class="progress-box--header">
				<div>
					<div class="progress-box--title">Reliability</div>
					<div class="progress-box--balance">?</div>
				</div>
			</div>
			<div class="progress-box--icons">
				<div></div>
...
export default Vue.extend({
	name: "p42_progress_comp_Reliability",
	props: ['progress', 'unlock'],
	data() {
		return {
			w: 0,
		}
