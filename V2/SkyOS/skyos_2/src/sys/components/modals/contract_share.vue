<template>
	<div class="contract_share theme--dark" :class="state.ui.mode">
			...
			<div class="centered">
				<div class="columns">
					...
					<div class="column">
						...
						<h1 class="title">{{ md.data.template.Name }}</h1>
		...
		<div class="info-section-bottom" v-if="md.data.template && md.data.contract">
			...
			<div class="centered">
				<div class="background" :style="'background-color: ' + (state.ui.color ? state.ui.colorDark : '#000000') + ''"></div>
...
import ChatFrame from "@/sys/components/chat.vue"
...
Textbox,
	...
	methods: {
		mapLoaded(map: any) {
			...
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('country-label-lg', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('country-label-md', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('country-label-sm', 'visibility', 'none');

			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('state-label-lg', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('state-label-md', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('state-label-sm', 'visibility', 'none');

			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('marine-label-lg-pt', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('marine-label-lg-ln', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('marine-label-md-pt', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('marine-label-md-ln', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('marine-label-sm-pt', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('marine-label-sm-ln', 'visibility', 'none');

			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-city-lg-n', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-city-lg-s', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-city-md-n', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-city-md-s', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-city-sm', 'visibility', 'none');


			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-islands-2', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-islands', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-islets-archipelago-aboriginal-2', 'visibility', 'none');
			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setLayoutProperty('place-islets-archipelago-aboriginal', 'visibility', 'none');

			this.$os.UntrackedMap['p42_sharecard_map_main'].map.setPaintProperty('contractPaths','line-opacity', this.state.ui.opacity);
	...
	mounted() {
		...
		this.$os.setThemeAccent({
			status: {
				bright: StatusType.NONE,
				dark: StatusType.NONE,
				shaded: false,
			},
			nav: {
				bright: StatusType.NONE,
		...
		if(this.md.data.contract.ImageURL.length) {
			this.$root.$data.services.colorSeek.find(this.md.data.contract.ImageURL, (color :any) => {
