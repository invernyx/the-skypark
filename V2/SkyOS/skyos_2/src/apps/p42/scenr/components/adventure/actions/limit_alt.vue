<template>
	<div>
		<div v-if="Action.Action == 'trigger_alt_start'">

			<div class="buttons_list_half">
				<textbox class="listed" :disabled="true" placeholder="Unique ID" type="text" v-model="Action.UID"></textbox>
				<textbox class="listed" placeholder="UI Label" type="text" v-model="Action.Params.Label"></textbox>
				<selector class="listed" placeholder="Relation" v-model="Action.Params.Relation">
		...
		<div v-if="Action.Action == 'trigger_alt_end'">
...
export default Vue.extend({
	name: "scenrAdventure_event_limit_alt",
	...
	methods: {
		...
		GetAvailable() {
			this.Available = this.Adventure.GetAvailable(this.Action, "trigger_alt_start", "trigger_alt_end");
