<template>
	<div>
		<div v-if="Action.Action == 'trigger_g_start'">
		...
		<div v-if="Action.Action == 'trigger_g_end'">
			<div class="buttons_list_half">
...
export default Vue.extend({
	name: "scenrAdventure_event_limit_g",
	...
	methods: {
		...
		GetAvailable() {
			...
			this.Available = this.Adventure.GetAvailable(this.Action, "trigger_g_start", "trigger_g_end");
