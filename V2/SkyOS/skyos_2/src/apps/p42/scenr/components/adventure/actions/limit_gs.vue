<template>
	<div>
		<div v-if="Action.Action == 'trigger_gs_start'">
		...
		<div v-if="Action.Action == 'trigger_gs_end'">
...
export default Vue.extend({
	...
	methods: {
		...
		GetAvailable() {
			...
			this.Available = this.Adventure.GetAvailable(this.Action, "trigger_gs_start", "trigger_gs_end");
