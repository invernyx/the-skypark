<template>
	<section class="tile" :class="'tile_' + (ind + 1) + ' tile_' + app.app_vendor + '_' + app.app_ident" v-on:click="open" :data-thook="'home_icon_' + app.app_vendor + '_' + app.app_ident">
