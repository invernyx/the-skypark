...
namespace TSP_Installer
{
    ...
    public partial class App : Application
    {
        ...
        internal static string ConfigPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"Parallel 42\The Skypark\2\config.json");
        internal static string AppDataDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"Parallel 42\The Skypark\2\");
        internal static Dictionary<string, string> Config = new Dictionary<string, string>() { { "install", "" } };
        internal static string DefaultInstallDir = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles) + @"\Parallel 42\The Skypark\";
        ...
        internal static string VersionChannel = "2";
        internal static string VersionDownload = "1";

        #region Products
        private static string apiUrl = "https://cdn.invernyx.com/skypark/1CE04F/leg-content/";
        ...
        List<UpdateInfo> Products = new List<UpdateInfo>()
        {
            new UpdateInfo()
            {
                ...
                ManifestsURL = apiUrl + "%version%/%channel%/manifests.zip?t=" + CacheTime,
                Modules = new List<UpdateModule>()
                {
                    new UpdateModule()
                    {
                        ...
                        ID = "transponder",
                        CanDropConsole = true,
                        DownloadURL = apiUrl + "%version%/%channel%/transponder.zip?t=" + CacheTime,
                        //CleanupExcess = true,
                    ...
                    new UpdateModule()
                    {
                        ...
                        ID = "skypad",
                        CanDropConsole = true,
                        DownloadURL = apiUrl + "%version%/%channel%/skypad.zip?t=" + CacheTime,
                        CleanupExcess = true,
                        //CleanupExcessExcludeRoot = true,
                    },
                    new UpdateModule()
                    {
                        ...
                        ID = "skyos",
                        CanDropConsole = true,
                        DownloadURL = apiUrl + "%version%/%channel%/skyos.zip?t=" + CacheTime,
                        //CleanupExcess = true,
                        //CleanupExcessExcludeRoot = true,
                    },
                    new UpdateModule()
                    {
                        ...
                        CanDropConsole = true,
                        SkipValidate = true,
                        DownloadURL = apiUrl + "%version%/common/topo.zip?t=" + CacheTime,
                        //CleanupExcess = true,
                        //CleanupExcessExcludeRoot = true,
                    },
                    //new UpdateModule()
                    ...
                    //    ID = "content",
                    //    CanDropConsole = true,
                    //    DownloadURL = apiUrl + "%version%/%channel%/content.zip?t=" + CacheTime,
                    //    CleanupExcess = true,
                    //    CleanupExcessExcludeRoot = true,
                    //},
                },
            ...
            new UpdateInfo()
            {
                ...
                Lic = LicenseApplication.Skypark,
                ManifestsURL = apiUrl + "%version%/%channel%/adventures_manifests.zip?t=" + CacheTime,
                Modules = new List<UpdateModule>()
                {
                    new UpdateModule()
                    {
                        ...
                        DownloadURL = apiUrl + "%version%/%channel%/adventures.zip?t=" + CacheTime,
                        //CleanupExcessExcludeRoot = true,
                    },
                },
            },
        ...
        void App_Startup(object sender, StartupEventArgs e)
        {
            ...
            #region Get Version
            var FoundVersionArg = ArgsList.Find(x => x.StartsWith("version|"));
            if(FoundVersionArg != null)
            {
                string[] spl = FoundVersionArg.Split('|');
                VersionChannel = spl[1];
                VersionDownload = spl[2];

                ConfigPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"Parallel 42\The Skypark", VersionChannel, "config.json");
                AppDataDirectory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"Parallel 42\The Skypark", VersionChannel);
            }
            #endregion
            ...
            using (RegistryKey parent = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall", true))
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        key.SetValue("Publisher", "TFDi Design");
                        key.SetValue("DisplayIcon", Path.Combine(location, @"Transponder\Transponder.exe"));
                        key.SetValue("URLInfoAbout", "https://tfdidesign.com/");
                        key.SetValue("Contact", "https://support.tfdidesign.com");
        ...
        public void Application_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            MessageBox.Show("It looks like something unexpected occured.\rA log file has been saved in " + LogPath + ". \r\rPlease open a ticket at https://support.tfdidesign.com \r\rSorry for the inconvenience.", "Immersive Updater", MessageBoxButton.OK, MessageBoxImage.Exclamation);
            Environment.Exit(1);
        }
        ...
        public static void GenerateLogFile(string path, Exception e)
        {
            ...
            try
            {
                using (StreamWriter writer = new StreamWriter(path, true))
                {
                    ...
                    writer.WriteLine("-----------------------------------------------------------------");
                    writer.WriteLine("------ Please open a ticket at https://support.tfdidesign.com ------");
        ...
        public class ControlWriter : TextWriter
        {
            ...
            public ControlWriter(string FilePath)
            {
                try
                {
                    ...
                    Buffer.Add("****************** Do not post this file online. Send this file via a ticket at https://support.tfdidesign.com ******************\n");
