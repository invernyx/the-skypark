...
namespace TSP_Transponder.Models.EventBus
{
    class Compute_AircraftCrash : Compute_Base
    {
        ...
        public override void Compute(long _TimeNow, TemporalData _TemporalLast, TemporalData _TemporalNewBuffer, EventsSession Session)
        {
            ...
            double difX = (_TemporalNewBuffer.VELOCITY_WORLD_X - _TemporalLast.VELOCITY_WORLD_X) / td;
            double difY = (_TemporalNewBuffer.VELOCITY_WORLD_Y - _TemporalLast.VELOCITY_WORLD_Y) / td;
            double difZ = (_TemporalNewBuffer.VELOCITY_WORLD_Z - _TemporalLast.VELOCITY_WORLD_Z) / td;
