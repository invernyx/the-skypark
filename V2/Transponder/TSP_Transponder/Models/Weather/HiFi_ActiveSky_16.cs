...
{
    class HiFi_ActiveSky_16
    {
        public static void Startup()
        {
            //List<Module> test = CollectModules(ActiveSimProc);

            //Module ASModule = test.Find(x => x.ModuleName == "as_connect_64.dll");
            
            //if(ASModule != null)
            //{
            //    IntPtr pAddressOfFunctionToCall = GetProcAddress(ASModule.BaseAddress, "SetRdrParams");
            //}
        }
