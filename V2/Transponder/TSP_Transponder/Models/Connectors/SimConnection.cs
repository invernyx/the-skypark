...
namespace TSP_Transponder.Models.Connectors
{
    public class SimConnection
    {
        ...
        public class TemporalData
        {
            ...
            public double VELOCITY_WORLD_X = 0;
            public double VELOCITY_WORLD_Y = 0;
            public double VELOCITY_WORLD_Z = 0;
            ...
            public void SetPayload(int Station, float WeightPounds)
            {
                if (Aircraft != null)
                {
                    if (Station < Aircraft.PayloadStationCount)
                    {
                        lock (PAYLOAD)
                        {
                            ...
                            PAYLOAD[Station] = WeightPounds;
                            if(Aircraft.PayloadStations != null)
                            {
                                Aircraft.PayloadStations[Station].Load = WeightPounds;
                            }
                        }
                    }
                }
